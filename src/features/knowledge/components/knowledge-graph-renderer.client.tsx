...
export interface KnowledgeGraphRendererClientProps {
  data: KnowledgeGraphData;
  onNodeClick?: (node: KnowledgeNode) => void;
  selectedNodeId?: string;
}

export function KnowledgeGraphRendererClient({ data, onNodeClick, selectedNodeId }: KnowledgeGraphRendererClientProps) {
...
export default KnowledgeGraphRendererClient;
